...
def init_database():
    with app.app_context():
        ...
        # Produits
        products = [
            Product(name='Security Handbook', description='OWASP guide', price=39.99, stock=10),
            Product(name='USB Rubber Ducky', description='Pentesting tool', price=49.99, stock=5),
            Product(name='Kali Linux Sticker', description='Cool sticker', price=2.99, stock=100),
        ]
